...
Route::get('/farm/{farm}/stocks','FarmController@getStocks')->middleware('auth:api');
...
Route::get('/farm/{farm}/crops','FarmController@crops')->middleware('auth:api');
...
Route::post('/crop/{crop}/add_description','CropController@addDescription')->middleware('auth:api','only.user');
Route::post('/crop/{crop}/update_values','CropController@update_values')->middleware('auth:api','only.user');
Route::post('/crop/{crop}/update_inventory_itens','CropController@update_inventory_itens')->middleware('auth:api','only.user');
...
Route::post('/percentage-multiple-activities','ActivityController@percentageMultipleStore')->middleware('auth:api','only.user');
